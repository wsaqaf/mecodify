...
if ($_GET['inspect'])
  {
    ...
    $data=$data.urldecode($_GET['user_name'])." (".$_GET['user_screen_name'].")</font></a><br><blockquote><font color=black><div style='word-wrap:break-word;overflow-wrap:break-word;'>".$_GET['clear_text']."</font></blockquote><hr></div><br>";
                  ...
                  if ($cnt+1>=$p && $cnt<$pp)
                   {
                     ...
                     "<td><div style='word-wrap:break-word;overflow-wrap:break-word;'>".hyper_link($row['clear_text'])." - (<a href='${row['tweet_permalink_path']}' target=_blank>Link</a>)".location($row['location_name'],$row['location_fullname'])."</div></td>".
