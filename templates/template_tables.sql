...
CREATE FUNCTION `SPLIT_STRING`(str VARCHAR(255), delim VARCHAR(12), pos INT) RETURNS varchar(255) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci
DETERMINISTIC
RETURN REPLACE(SUBSTRING(SUBSTRING_INDEX(str, delim, pos), LENGTH(SUBSTRING_INDEX(str, delim, pos-1)) + 1), delim, '');
CREATE FUNCTION `Nr_Twitter_Users`(year_value INT) RETURNS int(11)
READS SQL DATA
DETERMINISTIC
BEGIN
   ...
   ELSEIF year_value = 2010 THEN SET twitter_users = 54;
   ELSEIF year_value = 2011 THEN SET twitter_users = 117;
   ELSEIF year_value = 2012 THEN SET twitter_users = 185;
   ELSEIF year_value = 2013 THEN SET twitter_users = 241;
   ELSEIF year_value = 2014 THEN SET twitter_users = 288;
   ELSEIF year_value = 2015 THEN SET twitter_users = 305;
   ELSEIF year_value = 2016 THEN SET twitter_users = 318;
   ELSEIF year_value = 2017 THEN SET twitter_users = 330;
   ELSEIF year_value = 2018 THEN SET twitter_users = 321;
   ELSEIF year_value = 2019 THEN SET twitter_users = 330;
   ELSEIF year_value = 2020 THEN SET twitter_users = 353;
   ELSEIF year_value = 2021 THEN SET twitter_users = 397;
   ELSE SET twitter_users = 397;
   END IF;
