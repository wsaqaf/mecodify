...
$max_tweets_per_case = 50000; //maximum tweets per case (applies only to API Search & can be exceeded by 100 records max)
$upload_csv_files = 1; // Set to 1 to use CSV files generated by the xscraper extension (https://github.com/wsaqaf/xscraper). If 0, it requires X API configuration.
...
$demo_config['email'] = "demo@demo.demo"; //Make sure you have already created this account with the below password before setting up the demo!
$demo_config['pw'] = "demo";

$website_url = "http://localhost:8080"; //e.g., https://mecodify.org . Don't end with '/'
$website_title = "My Mecodify";


$mysql_db = getenv("MYSQL_DATABASE") ?: "mecodify_db"; //This is the default settings. If you have an exising MySQL database, you can modify them
$mysql_server = getenv("MYSQL_HOST") ?: "localhost";
$mysql_user = getenv("MYSQL_USER") ?: "mecodify_user";
$mysql_pw = getenv("MYSQL_PASSWORD") ?: "password";
...
function connect_mysql()
{
  ...
  if (!$link)
    die("Can't use $mysql_db : " . $link->error);
